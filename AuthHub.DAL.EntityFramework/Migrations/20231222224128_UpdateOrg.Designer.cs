...
namespace AuthHub.DAL.EntityFramework.Migrations
{
    ...
    [Migration("20231222224128_UpdateOrg")]
            ...
            modelBuilder.Entity("AuthHub.Models.Entities.Enums.AuthScheme", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 12, 22, 22, 41, 27, 426, DateTimeKind.Utc).AddTicks(8144),
                            LastUpdated = new DateTime(2023, 12, 22, 22, 41, 27, 426, DateTimeKind.Utc).AddTicks(8145),
                            Name = "JWT",
                            Value = 1
                        });
                });
            ...
            modelBuilder.Entity("AuthHub.Models.Entities.Enums.VerificationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 12, 22, 22, 41, 27, 426, DateTimeKind.Utc).AddTicks(8384),
                            LastUpdated = new DateTime(2023, 12, 22, 22, 41, 27, 426, DateTimeKind.Utc).AddTicks(8385),
                            Name = "UserEmail",
                            Value = 0
                        },
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 12, 22, 22, 41, 27, 426, DateTimeKind.Utc).AddTicks(8390),
                            LastUpdated = new DateTime(2023, 12, 22, 22, 41, 27, 426, DateTimeKind.Utc).AddTicks(8390),
                            Name = "PasswordReset",
                            Value = 1
                        });
                });
            ...
            modelBuilder.Entity("AuthHub.Models.Entities.Organizations.APIKeyAndSecretHash", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 12, 22, 22, 41, 27, 426, DateTimeKind.Utc).AddTicks(8418),
                            Hash = new byte[] { 82, 173, 66, 213, 53, 147, 34, 195, 227, 190 },
                            Iterations = 10,
                            LastUpdated = new DateTime(2023, 12, 22, 22, 41, 27, 426, DateTimeKind.Utc).AddTicks(8419),
                            Length = 10,
            ...
            modelBuilder.Entity("AuthHub.Models.Entities.Organizations.AuthSettings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 12, 22, 22, 41, 27, 426, DateTimeKind.Utc).AddTicks(8231),
                            ExpirationMinutes = 120,
                            HashLength = 8,
                            Issuer = "HomeEc",
                            Iterations = 10,
                            Key = "This is my auth key",
                            LastUpdated = new DateTime(2023, 12, 22, 22, 41, 27, 426, DateTimeKind.Utc).AddTicks(8231),
                            Name = "HomeEc JWT",
                            OrganizationID = new Guid("bcb980b4-b5b9-4bd6-9810-569dcd62feca"),
            ...
            modelBuilder.Entity("AuthHub.Models.Entities.Organizations.Organization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 12, 22, 22, 41, 27, 426, DateTimeKind.Utc).AddTicks(7785),
                            Email = "mattlantz88@gmail.com",
                            LastUpdated = new DateTime(2023, 12, 22, 22, 41, 27, 426, DateTimeKind.Utc).AddTicks(7788),
                            Name = "HomeEc"
                        });
                });
            ...
            modelBuilder.Entity("AuthHub.Models.Entities.Passwords.ClaimsKey", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 12, 22, 22, 41, 27, 426, DateTimeKind.Utc).AddTicks(8266),
                            IsDefault = false,
                            LastUpdated = new DateTime(2023, 12, 22, 22, 41, 27, 426, DateTimeKind.Utc).AddTicks(8266),
                            Name = "Name"
                        },
                        new
                        {
                            ...
                            AuthSettingsId = new Guid("48f46ec0-a09e-4d76-a1d0-385c0c813b1f"),
                            CreateDate = new DateTime(2023, 12, 22, 22, 41, 27, 426, DateTimeKind.Utc).AddTicks(8273),
                            IsDefault = false,
                            LastUpdated = new DateTime(2023, 12, 22, 22, 41, 27, 426, DateTimeKind.Utc).AddTicks(8273),
                            Name = "Role"
                        });
                });
