...
namespace AuthHub.DAL.EntityFramework.Migrations
{
    ...
    [Migration("20240226025952_AddRequireVerificationField")]
    partial class AddRequireVerificationField
    {
            ...
            modelBuilder.Entity("AuthHub.Models.Entities.Enums.AuthScheme", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 2, 26, 2, 59, 52, 233, DateTimeKind.Utc).AddTicks(856),
                            LastUpdated = new DateTime(2024, 2, 26, 2, 59, 52, 233, DateTimeKind.Utc).AddTicks(857),
                            Name = "JWT",
                            Value = 1
                        });
                });
            ...
            modelBuilder.Entity("AuthHub.Models.Entities.Enums.VerificationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 2, 26, 2, 59, 52, 233, DateTimeKind.Utc).AddTicks(1006),
                            LastUpdated = new DateTime(2024, 2, 26, 2, 59, 52, 233, DateTimeKind.Utc).AddTicks(1007),
                            Name = "UserEmail",
                            Value = 0
                        },
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 2, 26, 2, 59, 52, 233, DateTimeKind.Utc).AddTicks(1013),
                            LastUpdated = new DateTime(2024, 2, 26, 2, 59, 52, 233, DateTimeKind.Utc).AddTicks(1014),
                            Name = "PasswordReset",
                            Value = 1
                        });
                });
            ...
            modelBuilder.Entity("AuthHub.Models.Entities.Organizations.APIKeyAndSecretHash", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 2, 26, 2, 59, 52, 233, DateTimeKind.Utc).AddTicks(1056),
                            Hash = new byte[] { 82, 173, 66, 213, 53, 147, 34, 195, 227, 190 },
                            Iterations = 10,
                            LastUpdated = new DateTime(2024, 2, 26, 2, 59, 52, 233, DateTimeKind.Utc).AddTicks(1057),
                            Length = 10,
            ...
            modelBuilder.Entity("AuthHub.Models.Entities.Organizations.AuthSettings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 2, 26, 2, 59, 52, 233, DateTimeKind.Utc).AddTicks(902),
                            ExpirationMinutes = 120,
                            HashLength = 8,
                            Issuer = "HomeEc",
                            Iterations = 10,
                            Key = "This is my auth key",
                            LastUpdated = new DateTime(2024, 2, 26, 2, 59, 52, 233, DateTimeKind.Utc).AddTicks(903),
                            Name = "HomeEc JWT",
                            OrganizationID = new Guid("bcb980b4-b5b9-4bd6-9810-569dcd62feca"),
            ...
            modelBuilder.Entity("AuthHub.Models.Entities.Organizations.Organization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 2, 26, 2, 59, 52, 233, DateTimeKind.Utc).AddTicks(611),
                            Email = "mattlantz88@gmail.com",
                            LastUpdated = new DateTime(2024, 2, 26, 2, 59, 52, 233, DateTimeKind.Utc).AddTicks(615),
                            Name = "HomeEc"
                        });
                });
            ...
            modelBuilder.Entity("AuthHub.Models.Entities.Passwords.ClaimsKey", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 2, 26, 2, 59, 52, 233, DateTimeKind.Utc).AddTicks(953),
                            IsDefault = false,
                            LastUpdated = new DateTime(2024, 2, 26, 2, 59, 52, 233, DateTimeKind.Utc).AddTicks(954),
                            Name = "Name"
                        },
                        new
                        {
                            ...
                            AuthSettingsId = new Guid("48f46ec0-a09e-4d76-a1d0-385c0c813b1f"),
                            CreateDate = new DateTime(2024, 2, 26, 2, 59, 52, 233, DateTimeKind.Utc).AddTicks(962),
                            IsDefault = false,
                            LastUpdated = new DateTime(2024, 2, 26, 2, 59, 52, 233, DateTimeKind.Utc).AddTicks(963),
                            Name = "Role"
                        });
                });
