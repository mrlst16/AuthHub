...
namespace AuthHub.DAL.EntityFramework.Migrations
{
    ...
    [Migration("20221211024117_Add APIKeyAndSecretHash for Pawnder")]
    partial class AddAPIKeyAndSecretHashforPawnder
    {
            ...
            modelBuilder.Entity("AuthHub.Models.Enums.AuthScheme", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2022, 12, 11, 2, 41, 16, 652, DateTimeKind.Utc).AddTicks(5788),
                            LastUpdated = new DateTime(2022, 12, 11, 2, 41, 16, 652, DateTimeKind.Utc).AddTicks(5789),
                            Name = "JWT",
                            Value = 1
                        });
                });

            modelBuilder.Entity("AuthHub.Models.Enums.VerificationType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2022, 12, 11, 2, 41, 16, 652, DateTimeKind.Utc).AddTicks(6425),
                            LastUpdated = new DateTime(2022, 12, 11, 2, 41, 16, 652, DateTimeKind.Utc).AddTicks(6426),
                            Name = "UserEmail",
                            Value = 0
                        },
                        new
                        {
                            ...
                            CreateDate = new DateTime(2022, 12, 11, 2, 41, 16, 652, DateTimeKind.Utc).AddTicks(6429),
                            LastUpdated = new DateTime(2022, 12, 11, 2, 41, 16, 652, DateTimeKind.Utc).AddTicks(6430),
                            Name = "PasswordReset",
                            Value = 1
                        });
                });

            modelBuilder.Entity("AuthHub.Models.Organizations.APIKeyAndSecretHash", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2022, 12, 11, 2, 41, 16, 652, DateTimeKind.Utc).AddTicks(6451),
                            Hash = new byte[] { 82, 173, 66, 213, 53, 147, 34, 195, 227, 190 },
                            Iterations = 10,
                            LastUpdated = new DateTime(2022, 12, 11, 2, 41, 16, 652, DateTimeKind.Utc).AddTicks(6452),
                            Length = 10,
            ...
            modelBuilder.Entity("AuthHub.Models.Organizations.AuthSettings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2022, 12, 11, 2, 41, 16, 652, DateTimeKind.Utc).AddTicks(6047),
                            ExpirationMinutes = 120,
                            HashLength = 8,
                            Issuer = "Pawnder",
                            Iterations = 10,
                            Key = "This is my auth key",
                            LastUpdated = new DateTime(2022, 12, 11, 2, 41, 16, 652, DateTimeKind.Utc).AddTicks(6048),
                            Name = "Pawnder JWT",
                            OrganizationID = new Guid("bcb980b4-b5b9-4bd6-9810-569dcd62feca"),
                        ...
                        new
                        {
                            ...
                            AuthSchemeID = new Guid("2269d512-b2ec-47aa-82bd-ae68df0993f2"),
                            CreateDate = new DateTime(2022, 12, 11, 2, 41, 16, 652, DateTimeKind.Utc).AddTicks(6059),
                            ExpirationMinutes = 120,
                            HashLength = 8,
                            Issuer = "Audder",
                            Iterations = 10,
                            Key = "This is my auth key",
                            LastUpdated = new DateTime(2022, 12, 11, 2, 41, 16, 652, DateTimeKind.Utc).AddTicks(6059),
                            Name = "Audder_Clients",
            ...
            modelBuilder.Entity("AuthHub.Models.Organizations.Organization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2022, 12, 11, 2, 41, 16, 652, DateTimeKind.Utc).AddTicks(5981),
                            Email = "mattlantz88@gmail.com",
                            LastUpdated = new DateTime(2022, 12, 11, 2, 41, 16, 652, DateTimeKind.Utc).AddTicks(5983),
                            Name = "Pawnder"
                        },
                        new
                        {
                            Id = new Guid("0b674ac4-7079-4ad7-830a-c41cd6ab5204"),
                            CreateDate = new DateTime(2022, 12, 11, 2, 41, 16, 652, DateTimeKind.Utc).AddTicks(5999),
                            Email = "mattlantz88@gmail.com",
                            LastUpdated = new DateTime(2022, 12, 11, 2, 41, 16, 652, DateTimeKind.Utc).AddTicks(5999),
                            Name = "Audder"
                        });
                });
            ...
            modelBuilder.Entity("AuthHub.Models.Passwords.ClaimsKey", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2022, 12, 11, 2, 41, 16, 652, DateTimeKind.Utc).AddTicks(6114),
                            IsDefault = false,
                            LastUpdated = new DateTime(2022, 12, 11, 2, 41, 16, 652, DateTimeKind.Utc).AddTicks(6115),
                            Name = "Name"
                        },
                        new
                        {
                            ...
                            AuthSettingsId = new Guid("48f46ec0-a09e-4d76-a1d0-385c0c813b1f"),
                            CreateDate = new DateTime(2022, 12, 11, 2, 41, 16, 652, DateTimeKind.Utc).AddTicks(6122),
                            IsDefault = false,
                            LastUpdated = new DateTime(2022, 12, 11, 2, 41, 16, 652, DateTimeKind.Utc).AddTicks(6123),
                            Name = "Role"
                        });
                });
            ...
            modelBuilder.Entity("AuthHub.Models.Passwords.Password", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2022, 12, 11, 2, 41, 16, 652, DateTimeKind.Utc).AddTicks(6339),
                            ExpirationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LastUpdated = new DateTime(2022, 12, 11, 2, 41, 16, 652, DateTimeKind.Utc).AddTicks(6340),
            ...
            modelBuilder.Entity("AuthHub.Models.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2022, 12, 11, 2, 41, 16, 652, DateTimeKind.Utc).AddTicks(6310),
                            Email = "mattlantz88@gmail.com",
                            FirstName = "Pawnder",
                            IsOrganization = true,
                            LastName = "Organization",
                            LastUpdated = new DateTime(2022, 12, 11, 2, 41, 16, 652, DateTimeKind.Utc).AddTicks(6311),
                            UserName = "Pawnder",
            ...
            modelBuilder.Entity("AuthHub.Models.Organizations.APIKeyAndSecretHash", b =>
                {
                    b.HasOne("AuthHub.Models.Organizations.Organization", null)
                        ...
                        .HasForeignKey("AuthHub.Models.Organizations.APIKeyAndSecretHash", "OrganizationId")
            ...
            modelBuilder.Entity("AuthHub.Models.Verification.VerificationCode", b =>
                {
                    ...
                    b.HasOne("AuthHub.Models.Users.User", "User")
