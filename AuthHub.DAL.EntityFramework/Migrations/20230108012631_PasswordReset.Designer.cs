...
namespace AuthHub.DAL.EntityFramework.Migrations
{
    ...
    [Migration("20230108012631_PasswordReset")]
            ...
            modelBuilder.Entity("AuthHub.Models.Entities.Enums.AuthScheme", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 1, 8, 1, 26, 29, 901, DateTimeKind.Utc).AddTicks(2714),
                            LastUpdated = new DateTime(2023, 1, 8, 1, 26, 29, 901, DateTimeKind.Utc).AddTicks(2715),
                            Name = "JWT",
                            Value = 1
                        });
                });
            ...
            modelBuilder.Entity("AuthHub.Models.Entities.Enums.VerificationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 1, 8, 1, 26, 29, 901, DateTimeKind.Utc).AddTicks(3190),
                            LastUpdated = new DateTime(2023, 1, 8, 1, 26, 29, 901, DateTimeKind.Utc).AddTicks(3191),
                            Name = "UserEmail",
                            Value = 0
                        },
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 1, 8, 1, 26, 29, 901, DateTimeKind.Utc).AddTicks(3196),
                            LastUpdated = new DateTime(2023, 1, 8, 1, 26, 29, 901, DateTimeKind.Utc).AddTicks(3197),
                            Name = "PasswordReset",
                            Value = 1
                        });
                });
            ...
            modelBuilder.Entity("AuthHub.Models.Entities.Organizations.APIKeyAndSecretHash", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 1, 8, 1, 26, 29, 901, DateTimeKind.Utc).AddTicks(3225),
                            Hash = new byte[] { 82, 173, 66, 213, 53, 147, 34, 195, 227, 190 },
                            Iterations = 10,
                            LastUpdated = new DateTime(2023, 1, 8, 1, 26, 29, 901, DateTimeKind.Utc).AddTicks(3226),
                            Length = 10,
            ...
            modelBuilder.Entity("AuthHub.Models.Entities.Organizations.AuthSettings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 1, 8, 1, 26, 29, 901, DateTimeKind.Utc).AddTicks(2982),
                            ExpirationMinutes = 120,
                            HashLength = 8,
                            Issuer = "Pawnder",
                            Iterations = 10,
                            Key = "This is my auth key",
                            LastUpdated = new DateTime(2023, 1, 8, 1, 26, 29, 901, DateTimeKind.Utc).AddTicks(2983),
                            Name = "Pawnder JWT",
                            OrganizationID = new Guid("bcb980b4-b5b9-4bd6-9810-569dcd62feca"),
                        ...
                        new
                        {
                            ...
                            AuthSchemeID = new Guid("2269d512-b2ec-47aa-82bd-ae68df0993f2"),
                            CreateDate = new DateTime(2023, 1, 8, 1, 26, 29, 901, DateTimeKind.Utc).AddTicks(3007),
                            ExpirationMinutes = 120,
                            HashLength = 8,
                            Issuer = "Audder",
                            Iterations = 10,
                            Key = "This is my auth key",
                            LastUpdated = new DateTime(2023, 1, 8, 1, 26, 29, 901, DateTimeKind.Utc).AddTicks(3007),
                            Name = "Audder_Clients",
            ...
            modelBuilder.Entity("AuthHub.Models.Entities.Organizations.Organization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 1, 8, 1, 26, 29, 901, DateTimeKind.Utc).AddTicks(2935),
                            Email = "mattlantz88@gmail.com",
                            LastUpdated = new DateTime(2023, 1, 8, 1, 26, 29, 901, DateTimeKind.Utc).AddTicks(2937),
                            Name = "Pawnder"
                        },
                        new
                        {
                            Id = new Guid("0b674ac4-7079-4ad7-830a-c41cd6ab5204"),
                            CreateDate = new DateTime(2023, 1, 8, 1, 26, 29, 901, DateTimeKind.Utc).AddTicks(2945),
                            Email = "mattlantz88@gmail.com",
                            LastUpdated = new DateTime(2023, 1, 8, 1, 26, 29, 901, DateTimeKind.Utc).AddTicks(2946),
                            Name = "Audder"
                        });
                });
            ...
            modelBuilder.Entity("AuthHub.Models.Entities.Passwords.ClaimsKey", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 1, 8, 1, 26, 29, 901, DateTimeKind.Utc).AddTicks(3046),
                            IsDefault = false,
                            LastUpdated = new DateTime(2023, 1, 8, 1, 26, 29, 901, DateTimeKind.Utc).AddTicks(3047),
                            Name = "Name"
                        },
                        new
                        {
                            ...
                            AuthSettingsId = new Guid("48f46ec0-a09e-4d76-a1d0-385c0c813b1f"),
                            CreateDate = new DateTime(2023, 1, 8, 1, 26, 29, 901, DateTimeKind.Utc).AddTicks(3056),
                            IsDefault = false,
                            LastUpdated = new DateTime(2023, 1, 8, 1, 26, 29, 901, DateTimeKind.Utc).AddTicks(3057),
                            Name = "Role"
                        });
                });
            ...
            modelBuilder.Entity("AuthHub.Models.Entities.Passwords.Password", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 1, 8, 1, 26, 29, 901, DateTimeKind.Utc).AddTicks(3091),
                            LastUpdated = new DateTime(2023, 1, 8, 1, 26, 29, 901, DateTimeKind.Utc).AddTicks(3092),
